...
# Step 2: Render the Quarto site, both report tabs (Quarto auto-detects formats)
/Applications/quarto/bin/quarto render --no-cache
...
git add docs/ GMRI_Grants.csv GMRI_Engagement_Opportunities.csv
